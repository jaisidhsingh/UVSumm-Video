...
parser.add_argument(
    '--vsumm_data', 
    type=str, 
    default='../datasets/summe/helpers/eccv16_dataset_summe_google_pool5.h5',
...
def make_helpers():
    ...
    for k in list(vsumm_data.keys()):
        temp2[k] = int(vsumm_data[k]['n_frames'][()])

    temp3 = {}
    for k1 in temp1.keys():
        for k2 in temp2.keys():
            if temp1[k1] == temp2[k2]:
                temp3[k1[:-4]] = k2
    
    torch.save(temp3, "../datasets/summe/helpers/rename_helper.pt") 
    print(len(temp3.keys()))
