...
parser.add_argument(
    '--video_dir', 
    default='../datasets/tvsumm/videos',
    type=str, 
...
parser.add_argument(
    '--vsumm_data', 
    type=str, 
    default='../datasets/tvsumm/helpers/eccv16_dataset_tvsum_google_pool5.h5',
...
def make_dataset(video_dir, h5_path):
    rename_helper = torch.load("../datasets/tvsumm/helpers/rename_helper.pt")
